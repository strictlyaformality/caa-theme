...
function toggleMenu() {
  ...
  var $mask = document.getElementById('nav-menu-mask');
  $menu === null || $menu === void 0 ? void 0 : $menu.classList.toggle('nav__menu--open');
  $mask === null || $mask === void 0 ? void 0 : $mask.classList.toggle('nav__menu-mask--displayed');
}

document.addEventListener('DOMContentLoaded', function () {
  var $toggler = document.getElementById('nav-menu-toggle');
  var $mask = document.getElementById('nav-menu-mask');
  var $close = document.getElementById('nav-menu-close');
  $toggler === null || $toggler === void 0 ? void 0 : $toggler.addEventListener('click', toggleMenu);
  $mask === null || $mask === void 0 ? void 0 : $mask.addEventListener('click', toggleMenu);
  $close === null || $close === void 0 ? void 0 : $close.addEventListener('click', toggleMenu);
});
...
function toggleSearch() {
  ...
  $modal === null || $modal === void 0 ? void 0 : $modal.classList.toggle('nav__search--open');
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  $open === null || $open === void 0 ? void 0 : $open.addEventListener('click', toggleSearch);
  $close === null || $close === void 0 ? void 0 : $close.addEventListener('click', toggleSearch);
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcaa_theme"] = self["webpackChunkcaa_theme"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["dist/css/theme"], () => (__webpack_require__("./src/index.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["dist/css/theme"], () => (__webpack_require__("./src/scss/theme.scss")))
